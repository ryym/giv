...
export const fetchNotifs = oldestUpdatedAt => action(FETCH_UNREAD_NOTIFS, { oldestUpdatedAt });
...
export const fetchIssueSuccess = issue => action(FETCH_ISSUE_SUCCESS, { issue });
